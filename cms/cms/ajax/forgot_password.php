<?php 
    ...
    if(isset($_POST["forgot_email"]) && $_POST["forgot_email"]!='')
    {
        ...
        $gen_password = create_password(8);
    
        $update_pass = update('users','password=:password,confirm_password=:confirm_password','where email="'.$email.'" ',array(':password'=>$gen_password,':confirm_password'=>$gen_password));

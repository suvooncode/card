<?php 
    ...
    $findcontent = find("all",$table,"*","where 1 order by process_content_id desc",array());
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="" method="POST">
                                ...
                                <label for="">Add Process Content</label>
                                <br>
                                <textarea name="content" col="10" row="7" class="form-control" id=""></textarea>
                                <br>
                                <button type="submit" class="btn btn-primary" name="save">Add Process Content</button>

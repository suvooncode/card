<?php 
    ...
    $findcontent = find("all",$table,"*","where 1 order by main_content_id desc",array());
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
   <?php include("preloader.php") ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="" method="POST">
                                ...
                                <label for="">Add Main Content</label>
                                <br>
                                <textarea name="content" col="10" row="7" class="form-control" id=""></textarea>
                                <br>
                                <button type="submit" class="btn btn-primary" name="save">Add Content</button>
    ...
    <script>
		$(function(){
			<?php if($savecontent) { ?>
				swal("Content Added","main content added successfully","success");
			<?php } ?>
		});
	</script>
</body>

<?php 
    ...
    $findcards = find("all",$table,"*","where ucd.user_id='$user_id' order by ucd.card_id desc",array());
?>
<!doctype html>
<html lang="en">
	<head>
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="login-button text-right">
							<a href="" href="">Hi <?=$_SESSION["name"]?></a>
						</div>
					</div>
				</div>
			</div>
                    ...
                    if($findcards){
						...
						<?php } } else { ?> 
                            <div class="col-lg-12 text-center mt-5 loadmore-button">
						        <a href="all_cards.php">you have No Cards yet click here to collect.</a>
					        </div> 
                    <?php } ?>
